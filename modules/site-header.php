<!-- <nav class="main-nav">
	<a  class="attention-voice logo <?= $currentPage['name'] === 'home' ? 'highlight' : ''?>" href="<?= ENV === 'production'? '/' : '?page=home'?>">StudioErnie</a>
	...
	<ul class="visually-hidden">
		...
		<li data-tilt data-tilt-scale="1.1" class="external-link">
			<a class="attention-voice" href="mailto:ersaavedra.nc@gmail.com">Let's Talk</a>
