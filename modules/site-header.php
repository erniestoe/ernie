<nav class="main-nav visually-hidden">
	<ul>
		<li data-tilt data-tilt-scale="1.1">
			<a class="attention-voice <?= $currentPage['name'] === 'home' ? 'highlight' : ''?>" href="<?= ENV === 'production'? '/' : '?page=home'?>">Home</a>
		</li>
		<!-- <li data-tilt data-tilt-scale="1.1">
		<?php if(ENV === 'local'): ?>
		...
		<li data-tilt data-tilt-scale="1.1">
			<a class="attention-voice <?= $currentPage['name'] === 'design' ? 'highlight' : ''?>" href="<?= ENV === 'production'? '/design' : '?page=design'?>">Playground</a>
		</li>
		<li data-tilt data-tilt-scale="1.1">
		...
		<li data-tilt data-tilt-scale="1.1">
			...
			<svg class="mail" xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#F5F5F5" viewBox="0 0 256 256"><path d="M224,48H32a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A8,8,0,0,0,224,48ZM203.43,64,128,133.15,52.57,64ZM216,192H40V74.19l82.59,75.71a8,8,0,0,0,10.82,0L216,74.19V192Z"></path></svg>
		</li>
	</ul>
</nav>